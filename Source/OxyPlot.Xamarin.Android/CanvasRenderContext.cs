...
namespace OxyPlot.Xamarin.Android
{
    ...
    public class CanvasRenderContext : RenderContextBase
    {
        ...
        public override int ClipCount => this.canvas.SaveCount;
        ...
        public override void DrawLine(IList<ScreenPoint> points, OxyColor stroke, double thickness, EdgeRenderingMode edgeRenderingMode, double[] dashArray, LineJoin lineJoin)
        {
            this.paint.Reset();
            {
                this.path.Reset();
                {
                    this.SetPath(points, edgeRenderingMode == EdgeRenderingMode.PreferGeometricAccuracy);
                    this.SetStroke(stroke, thickness, dashArray, lineJoin, edgeRenderingMode == EdgeRenderingMode.PreferGeometricAccuracy);
