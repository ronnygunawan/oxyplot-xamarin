...
namespace OxyPlot.Xamarin.iOS {
	...
	public static class ConverterExtensions {
		...
		public static ScreenPoint ToScreenPoint(
			this CGPoint p
		) {
		...
		public static OxyTouchEventArgs ToTouchEventArgs(
			this UITouch touch,
			UIView view
		) {
		...
		/// <param name="p">The point to convert.</param>
		/// <returns>The converted point.</returns>
		public static CGPoint ConvertAliased(
			this ScreenPoint p
		) {
		...
		public static CGRect ConvertAliased(
			this OxyRect rect
		) {
